			...
			return [
				...
				function (regexp, replaceValue) {
					...
					for (var i = 0; i < results.length; i++) {
						...
						var position = max(
							min$1(_toInteger(result.index), S.length),
							0
						);
						var captures = [];
		...
		(function () {
			function SimpleBar(element, options) {
				...
				this.drag = function (e) {
					...
					var dragPerc =
						dragPos /
						track.rect[_this.axis[_this.draggedAxis].sizeAttr]; // Scroll the content by the same percentage.
				...
				this.recalculate = lodash_throttle(
					this.recalculate.bind(this),
					64
				);
				this.onMouseMove = lodash_throttle(
				...
				SimpleBar.getRtlHelpers = lodash_memoize(
				...
				[
					...
					},
					{
						...
						value: function initDOM() {
							...
							if (
								Array.from(this.el.children).filter(function (
									child
								) {
					...
					},
					{
						...
						value: function recalculate() {
							...
							this.axis.y.forceVisible =
								...
								this.options.forceVisible === true;
							this.axis.x.scrollbar.size = this.getScrollbarSize(
								"x"
							);
					...
					},
					{
						...
						value: function removeListeners() {
							...
							[
								...
								_this4.el.removeEventListener(
									e,
									_this4.onPointerEvent
								);
							});
							this.el.removeEventListener(
								"mousemove",
				...
				[
					...
					},
					{
						...
						value: function getElOptions(el) {
							var options = Array.from(el.attributes).reduce(
