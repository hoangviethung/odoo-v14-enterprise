...
class ResConfigSettings(models.TransientModel):
    ...
    def set_values(self):
        ...
        colors = self.env['bemo_theme.scss_editor'].get_values(
        ...
        if(any(colors_changed)):
            ...
            self.env['bemo_theme.scss_editor'].replace_values(
                SCSS_URL, XML_ID, variables
            )
        param.set_param('bemo_theme.background_blend_mode', self.theme_background_blend_mode)
        return res
